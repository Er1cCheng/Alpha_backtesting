...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description='PyTorch Quantitative Modeling for Portfolio Allocation')
    ...
    print(f"Loaded data with {len(data_dict['si'])} entries and {len(set(data_dict['si']))} unique stocks")
    
    # Feature engineering with PyTorch
    print("Performing PyTorch feature engineering...")
    feature_eng = PyTorchFeatureEngineering(data_dict, device=args.device)
